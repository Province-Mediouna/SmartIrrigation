...
export default function DronesPage() {
  ...
  return (
    <div className="container mx-auto p-4 md:p-6">
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Surveillance aérienne et collecte de données
          </p>
        </div>
        ...
        <div className="lg:col-span-1">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Sélectionnez un drone pour voir les détails
              </CardDescription>
            </CardHeader>
            <CardContent>
              <DroneList
          ...
          {selectedDroneId ? (
            <Tabs defaultValue="details">
              ...
              <TabsContent value="details">
                {selectedDrone && <DroneDetails drone={selectedDrone} />}
              </TabsContent>
      ...
      <DroneCreateModal
        open={showCreateDroneModal}
        onOpenChange={setShowCreateDroneModal}
        onSuccess={() => {
          // Idéalement, rafraîchir la liste des drones ici
          console.log("Drone créé avec succès !");
        }}
      />
