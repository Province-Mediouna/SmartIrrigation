...
export function WaterUsageChart({ dateRange, parcelId }: WaterUsageChartProps) {
        ...
        if (view === "daily") {
          ...
          for (let i = 13; i >= 0; i--) {
            ...
            mockData.push({
              ...
              irrigation: Math.round(80 + Math.sin(i / 3) * 30 + Math.random() * 20),
          ...
          for (let i = 7; i >= 0; i--) {
            ...
            mockData.push({
              date: `S${Math.floor(date.getDate() / 7) + 1} ${date.toLocaleString("fr-FR", { month: "short" })}`,
              irrigation: Math.round(500 + Math.sin(i / 2) * 200 + Math.random() * 100),
          ...
          for (let i = 11; i >= 0; i--) {
            ...
            mockData.push({
              ...
              irrigation: Math.round(2000 + Math.sin(i / 6) * 1000 + Math.random() * 500),
              rainfall: Math.round(200 + Math.cos(i / 3) * 300 + Math.random() * 200),
            })
          }
        }
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">
            Impossible de charger les données de consommation d'eau. Veuillez réessayer.
          </p>
        </CardContent>
      </Card>
    )
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Consommation d'eau</CardTitle>
        <CardDescription>Analyse de la consommation d'eau par irrigation et apport pluviométrique</CardDescription>
